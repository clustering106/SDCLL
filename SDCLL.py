...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Use SDCLL for clustering')
    parser.add_argument('--mode', default='train_test', choices=['train_full', 'pretrain'], help='mode')
    ...
    parser.add_argument('--dataset', default='MNIST-test',
                        choices=['MNIST-train', 'custom', 'MNIST-test', 'MNIST-full', 'USPS', 'fashion_mnist'],
    ...
    if dataset == 'MNIST-train':
        ...
        dataset = mnist.FashionMNIST('../data', train=True, download=True,
                              transform=transforms.Compose([
                                   transforms.ToTensor(),
